...
## Meeting your first API
You can head over to Wikipedia if you want to learn about the formal definition of API. For the purposes of this tutorial we can think of APIs as a way of abstracting data away from any specific language or DB and into a universal format like JSON, and making it accessible over the web. 
